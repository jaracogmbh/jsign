...
public interface SigningService {
     ...
     */
    byte[] sign(SigningServicePrivateKey privateKey, String algorithm, byte[] data) throws GeneralSecurityException, SignRequestFailedException, FailedSignatureExtractionException;
}
